...
public class Helper {
    ...
    public static void Create_Event_MySQL(String Event_ID,String  Name, String  Location,String  Start_Date,String  Start_Time,String End_Date,
        ...
        sqlHelper.insert(Table_Events_Users.Table_Name, new String[]{Event_ID, Constants.MY_User_ID, Constants.Yes, Constants.Manager});
    ...
    public static void Create_Event_ServerSQL(Context context, String Event_ID,String  Name, String  Location, String  Start_Date, String  Start_Time, String End_Date,
        ...
        new EventUser_AsyncTask_insert(context).execute(Event_ID, Constants.MY_User_ID, Constants.Yes, Constants.Manager);
        String Chat_ID = Table_Chat.Table_Name + Helper.Clean_Event_ID(Event_ID);
    ...
    public static ArrayList<String>[] getFriends_From_Event(String Event_ID){
        return sqlHelper.select(null, Table_Events_Users.Table_Name, new String[]{Table_Events_Users.Event_ID},
    ...
    public static void Send_Message_To_Friend_By_Event_Except_One(Context context, String Event_ID, String User_ID, String message){
        ArrayList<String>[] dbFriends = getFriends_From_Event(Event_ID);
        for(String to:dbFriends[1]) {
            if(!to.equals(User_ID) && !to.equals(Constants.MY_User_ID)) {
                new SendMessage_AsyncTask(context).execute(Constants.MY_User_ID, message, to);
            }
        }
    }
    ...
    public static boolean isFriend_Exist_in_Event_MySql(String Event_ID, String User_ID){
        return !(sqlHelper.select(null, Table_Events_Users.Table_Name,new String[]{Table_Events_Users.Event_ID,
                Table_Events_Users.User_ID},new String[]{Event_ID, User_ID},null)[0].isEmpty());
    }

    public static void Event_Friend_Insert_MySQL(String Event_ID, String User_ID, String Attend, String Permission_Value){
        sqlHelper.insert(Table_Events_Users.Table_Name, new String[]{Event_ID, User_ID, Attend, Permission_Value});
    }

    public static void User_Insert_MySQL(String User_ID){
        ArrayList<String>[] dbUsers = sqlHelper.select(null, Table_Users.Table_Name,new String[]{Table_Users.User_ID},new String[]{User_ID},null);
    ...
    public static String getNickname(String User_ID){
        if(User_ID.equals(Constants.UnCheck)){
            return "";
        }
        ...
        } else if (User_ID.equals(Constants.MY_User_ID)) {
